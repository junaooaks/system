...
<div id="datagrid">
    <table width="100%">
        <tr>
            ...
            <td id="voltar"><a href="#" class="voltar" onclick="javascript:mudaConteudo('app/view/gridNfs.php?vd=<?php echo $_GET['ven'];?>');"><img src="resources/images/voltar.png" /></a>
            </td>
        </tr>
    </table>
    <hr>
    <fieldset>
        ...
        <form method="GET" action="" id="tr" name="custo">
            ...
            <h1>STATUS:
                ...
                <input type="hidden" id="idcliente" value="<?php echo $_GET['ven']; ?>" name="idvendedor" />
            ...
            <table border="0">
                ...
                <tr>
                    <td>Codig.</td>
                    <td><input name="unitario" type="text" class="effect" id="idcusto" onkeyup="up(this)" value="<?php echo $idcliente; ?>" size="10" /></td>
                    <td>Nome :</td>
                ...
                <tr>
                    <td>CEP:</td>
                    <td><input name="st" type="text" class="effect" id="frete" onkeyup="up(this)"  value="<?php echo $cep; ?>" size="10" maxlength="10"/></td>
                    <td>End..:</td>
                    <td colspan="3"><input name="ipi" type="text" class="effect" id="st" onkeyup="up(this)" value="<?php echo $endereco; ?>" size="80" /></td>
                </tr>
                <tr>
                    <td>Cidade:</td>
                    <td><input name="frete" type="text" class="effect" id="frete_p" onkeyup="up(this)" value="<?php echo $cidade; ?>" size="10" maxlength="10" /></td>
                    <td>Bairro:</td>
                    <td><input name="frete_p" type="text" class="effect" id="ipi" onkeyup="up(this)" value="<?php echo $bairro; ?>" size="20" /></td>
                    <td>N°</td>
                    <td><input name="preco_custo" type="text" class="effect" id="unitario" value="<?php echo $numero; ?>" size="10" maxlength="10" onkeyup="up(this)"/></td>
                </tr>
            </table>
